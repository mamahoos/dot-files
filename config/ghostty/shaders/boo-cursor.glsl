// Vendored from https://github.com/hced/ghostty-cursor-trails (boo-cursor.glsl)
// MIT License — Copyright (c) 2026 H. Cederblad. See LICENSE.hced.
// Tuned for snappy per-keystroke / Neovim-style cursor motion (MIN_MOVE_DISTANCE = 0).
